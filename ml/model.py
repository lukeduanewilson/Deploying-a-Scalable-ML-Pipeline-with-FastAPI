...
#from sklearn.tree import RandomForestClassifier - decided against this
...
def train_model(X_train, y_train):
   ...
   # Chose RBF kernel because it's used commonly and it's similar to gaussian. The link below helped me understand the usage much better
